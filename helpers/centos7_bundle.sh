...
rpm -iUv http://pkgs.repoforge.org/rpmforge-release/rpmforge-release-0.5.3-1.el7.rf.x86_64.rpm

# add EPEL repo
rpm --import https://fedoraproject.org/static/0608B895.txt
rpm -iUv http://dl.fedoraproject.org/pub/epel/7/x86_64/e/epel-release-7-5.noarch.rpm
