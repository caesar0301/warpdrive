...
" Employ vim-nerdtree-tabs to enforce consistent nerdtree
...
nmap <silent> <leader>gs :ALESymbolSearch<cr>
...
" Disable the fallback to vim defaults
...
" Formatters
let g:formatdef_google_java_format='"java -jar ~/.vim_runtime/sources_non_forked/bin/google-java-format-1.15.0-all-deps.jar -"'
let g:formatters_java=['google_java_format']
let g:formatdef_gofmt_1='"gofmt"'
let g:formatdef_cmakefmt='"/usr/local/bin/cmake-format -"'
